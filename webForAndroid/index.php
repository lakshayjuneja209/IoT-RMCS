      ...
      updateFeed();
		...
		$(document).ready(function(){
    		$("#button1on").click(function(){
        		$.ajax({url: "change_device_status.php?status=1&device_id=1", success: function(result){document.getElementById('stat1').innerHTML = 'On ';
              /*document.getElementById('led1').checked = true;*/}});
    		});
		});
		$(document).ready(function(){
    		$("#button1off").click(function(){
        		$.ajax({url: "change_device_status.php?status=0&device_id=1", success: function(result){document.getElementById('stat1').innerHTML = 'Off';
              /*document.getElementById('led1').checked = false;*/}});
    		});
		});
		$(document).ready(function(){
    		$("#button2on").click(function(){
        		$.ajax({url: "change_device_status.php?status=1&device_id=2", success: function(result){document.getElementById('stat2').innerHTML = 'On ';
          /*document.getElementById('led2').checked = true;*/}});
    		});
		});
		$(document).ready(function(){
    		$("#button2off").click(function(){
        		$.ajax({url: "change_device_status.php?status=0&device_id=2", success: function(result){document.getElementById('stat2').innerHTML = 'Off';
              /*document.getElementById('led2').checked = false;*/}});
    		});
		});
		$(document).ready(function(){
    		$("#button3on").click(function(){
        		$.ajax({url: "change_device_status.php?status=1&device_id=3", success: function(result){document.getElementById('stat3').innerHTML = 'On ';
              /*document.getElementById('led3').checked = true;*/}});
    		});
		});$(document).ready(function(){
    		$("#button3off").click(function(){
        		$.ajax({url: "change_device_status.php?status=0&device_id=3", success: function(result){document.getElementById('stat3').innerHTML = 'Off';
              /*document.getElementById('led3').checked = false;*/}});
    		});
		});$(document).ready(function(){
    		$("#button4on").click(function(){
        		$.ajax({url: "change_device_status.php?status=1&device_id=4", success: function(result){document.getElementById('stat4').innerHTML = 'On ';
              /*document.getElementById('led4').checked = true;*/}});
    		});
		});$(document).ready(function(){
    		$("#button4off").click(function(){
        		$.ajax({url: "change_device_status.php?status=0&device_id=4", success: function(result){document.getElementById('stat4').innerHTML = 'Off';
              /*document.getElementById('led4').checked = false;*/}});
    		});
		});
...
<h1>Device Manager</h1><br><br>
  ...
  (Off)</span> <!-- <input disabled='true' id = "led1" type="radio" name="radical" /> -->
  </center>   
  <br><br>
  <center>
  Device 2 &nbsp;&nbsp;&nbsp;
  ...
  (Off)</span>  <!-- <input disabled='true' id = "led2" type="radio" name="radical2" /> -->
  </center> 
  <br><br>
  <center>
  Device 3 &nbsp;&nbsp;&nbsp;
  ...
  (Off)</span>  <!-- <input disabled='true' id = "led3" type="radio" name="radical3" / -->
  </center> 
  <br><br>
  <center>
  Device 4 &nbsp;&nbsp;&nbsp;
  ...
  (Off)</span>  <!-- <input disabled='true' id = "led4" type="radio" name="radical4" /> -->
  </center> 
  <br><br>
